...
// 
if (age>16){
  console.log("set canDrive to true");
}else (age<16){
  console.log("set canDrive to false");
};
...
var responseCreator = function(param){
  ...
  return param= 'Green is okay'.}
    else if (colorReponse == red){
  return param='I heart red'.}
    else (colorResponse){
  return param='What is your favorite color?'    
}
...
function greeter (name,number) {
      return name,number="Hi! I am name and I am number years old"}
//Unsure